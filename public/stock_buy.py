...
# %% [markdown]
# ## **SP500 Stock (Standard & Poor's 500)**
...
stock[(stock['Avg_Return'] > stock['Dev_Return'])]
us_stock = stock[(stock['Avg_Return'] > stock['Dev_Return'])]['Stock'].tolist()
...
# %%
# Function for Stock Principle to plot the MACD
